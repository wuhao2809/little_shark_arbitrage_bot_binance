...
def process_trading(symbol_1: str, symbol_2: str, original_z_score: float, num_wave: int):
    ...
    trading_interval_count = 0
    
    while not exit_flag:
        trading_interval_count += 1
        trading_flag = check_trading_status(symbol_1, symbol_2, original_z_score, limit_end_trading_time, trading_interval_count)
        time.sleep(1)
