...
def get_current_z_score_dynamic(symbol_1: str, symbol_2: str):
    ...
    series_1 = binance_get_recent_close_price(symbol=symbol_1, interval=INTERVAL, limit=Z_SCORE_WINDOW * 3)
    series_2 = binance_get_recent_close_price(symbol=symbol_2, interval=INTERVAL, limit=Z_SCORE_WINDOW * 3)
    
    spread, hedge_ratio_list = calculate_spread_hedge_ratio_window(series_1, series_2, Z_SCORE_WINDOW)
...
# print(get_current_hedge_ratio_dynamic("AXSUSDT", "SANDUSDT"))

def check_trading_status(symbol_1, symbol_2, original_z_score, limit_end_trading_time):
