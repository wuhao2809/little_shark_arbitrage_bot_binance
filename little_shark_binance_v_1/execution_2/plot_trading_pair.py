...
def plot_reference_trading(symbol_1, symbol_2, hedge_ratio, num_wave=0):
    ...
    price_symbol_1 = binance_get_recent_close_price(symbol_1, INTERVAL, 2 * Z_SCORE_WINDOW + TRADING_TIME_LIMIT_INTERVALS)
    price_symbol_2 = binance_get_recent_close_price(symbol_2, INTERVAL, 2 * Z_SCORE_WINDOW + TRADING_TIME_LIMIT_INTERVALS)
