    ...
    while(num_wave <= WAVE_LIMIT):
        try:
            ...
            if status == "Searching Trading Pairs":
                ...
                symbol_1, symbol_2 = process_get_target_symbols_dynamic(num_wave)
            ...
            if status == "Trading":
                ...
                total_invested_value, exit_z_score = process_trading(symbol_1, symbol_2, hedge_ratio, original_z_score, num_wave)
